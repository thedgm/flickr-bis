...
(function () {
    var showPhotos = function () {
        var searched = document.getElementById("search").value, photos = req.responseXML.getElementsByTagName("photo"), clone_btn = document.getElementById('clone');
    ...
    var constructImageURL = function (photo, size) {
    ...
    var PHOTOS_PER_CALL = 20, search_in_progress = false, req, page = -1, download_img = function (e) {
        ...
        var h = document.querySelector('.frame:not(.off)'), p = h.previousElementSibling;
        if (p) {
        ...
        var h = document.querySelector('.frame:not(.off)'), n = h.nextElementSibling;
        if (n) {
        ...
        var body = document.body, clone = document.createElement("button"), clone_text = document.createTextNode('Tab'), search = document.createElement("input"), pics = document.createElement("div"), bottom = document.createElement("div");
        clone.id = 'clone';
        clone.disabled = true;
